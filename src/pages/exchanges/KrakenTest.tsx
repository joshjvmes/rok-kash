...
export default function KrakenTest() {
    ...
    async function fetchInitialPairs() {
      try {
        ...
        toast({
          ...
          description: "Could not fetch trading pairs from Kraken"
        });
        setIsLoading(false);
      }
    }
  ...
  useEffect(() => {
    ...
    const updatePrice = async () => {
      try {
        ...
        const price = await fetchCCXTPrice('kraken', currentPair.symbol);
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4">Kraken Trading Pairs</h1>
      <Card className="p-4">
